...
from base import dataset, device, log, models, parser, trainer, darts, darts_trainer
...
if __name__ == '__main__':
    ...
    def restore_model_params_and_replace(pack=None):
        ...
        if pack is not None:
            ...
            canvas.replace(model, partial(darts.ParallelPlaceholder, pack), args.device)
    ...
    for i in range(train_range):
        ...
        for j in round_range:
            ...
            if macs_not_satisfied or params_not_satisfied:
                ...
                # Update totals 
                kernel_list.append(kernel_pack.module)
        ...
        while True:
            try:
                ...
                args.epochs = 100
                train_metrics, eval_metrics = darts_trainer.train(args, model=model,
        ...
        try:
            ...
            args.epochs = 100
            train_metrics, eval_metrics, alphas_dict = darts_trainer.train(args, model=model,
                              train_loader=train_loader, eval_loader=eval_loader,
                              search_mode=True)
        ...
        extra = {'alphas_dict': alphas_dict, 'proxy_score': proxy_score, 'g_macs': final_g_macs, 'm_params':final_m_params}
        if exception_info:
