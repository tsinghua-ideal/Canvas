...
class Kernel_3792100198503982614(nn.Module):
    def __init__(self, c: int, h: int, w: int):
        ...
        self.p_1_w = nn.Parameter(torch.ones((1, self.c, 1, 1,)), requires_grad=True)
        ...
        self.p_4 = nn.Conv1d(self.c, self.c, 3, padding=1, groups=1, bias=False)
        # FC: p_5
        self.p_5 = nn.Conv2d(self.c, self.c, 1, padding=0, groups=1, bias=False)
        # BSub: p_7
        pass
        # FC: p_8
        self.p_8 = nn.Conv2d(self.c, self.c, 3, padding=1, groups=4, bias=False)
        # BMax: p_9
        pass
        # BMM_0_0: p_10
        pass
