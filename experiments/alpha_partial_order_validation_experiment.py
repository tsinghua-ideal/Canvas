...
if __name__ == '__main__':
    ...
    for start_idx in range(0, len(subfolders), args.canvas_number_of_kernels):
        ...
        extra = {'magnitude_alphas': parallel_kernels_train_eval_metrics["magnitude_alphas"],'kernel_pack_list': folder_names, 'sum_sorted_top1_ranking': sum_sorted_top1_ranking}
        if exception_info:
